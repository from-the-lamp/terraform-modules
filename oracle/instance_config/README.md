...
| <a name="input_assign_public_ip"></a> [assign\_public\_ip](#input\_assign\_public\_ip) | A flag indicating whether to assign a public IP to the instance. | `bool` | `false` | no |
...
| <a name="input_nsg_ids"></a> [nsg\_ids](#input\_nsg\_ids) | A list of Network Security Group (NSG) IDs to be associated with the instance. | `list(string)` | `[]` | no |
