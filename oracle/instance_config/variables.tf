...
variable "nsg_ids" {
  type        = list(string)
  default     = []
  description = "A list of Network Security Group (NSG) IDs to be associated with the instance."
}

variable "assign_public_ip" {
  type        = bool
  default     = false
  description = "A flag indicating whether to assign a public IP to the instance."
}
